...
package android.prosotec.proyectocierzo.mediasession.client;
...
public class MediaBrowserHelper {
    ...
    public void onCreate() {
        ...
        Log.d(TAG, "onCreate: Creating MediaBrowser, and connecting");
    }
    ...
    public void onDestroy() {
        ...
        resetState();
        Log.d(TAG, "onDestroy: Releasing MediaController, Disconnecting from MediaBrowser");
    }
